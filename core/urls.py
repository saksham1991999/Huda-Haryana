...
urlpatterns = [
    ...
    path('addproperty', views.myProperties, name='addproperty'),
    path('editproperty/<int:id>', views.myProperties, name='editproperty'),
    path('deleteproperty/<int:id>', views.myProperties, name='deleteproperty'),
